//****************************************
// Tests for RadioButtonViewModel class
// National Instruments Copyright 2015
//****************************************

describe('A RadioButtonViewModel', function () {
    'use strict';
    var viName = 'viName';
    var controlId = 'RadioButtonViewModelId';
    ...
    it('allows to call the radioButtonViewModelMethods  method', function () {
        ...
        viewModel.radioButtonViewModelMethods();
    ...
    it('allows to call the modelPropertyChanged method with a property update', function () {
        ...
        expect(controlModel.groupName).toEqual(settings.groupName);
        ...
        expect(controlModel.groupName).toEqual(updateSettings.groupName);
    ...
    it('allows instantiation with a false value', function () {
        ...
        expect($('#' + controlId).jqxRadioButton('checked')).toEqual(true);
