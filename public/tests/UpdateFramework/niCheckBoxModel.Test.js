...
describe('A CheckBoxModel', function () {
    ...
    beforeEach(function () {
        ...
        controlModel = new NationalInstruments.HtmlVI.CheckBoxModel(id);
    });
    ...
    // -------------------------------------------------
    it('allows to call the checkBoxModelMethods method', function () {
        ...
        controlModel.checkBoxModelMethods();
    });
