...
describe('A ProgressBar', function () {
    ...
    beforeEach(function () {
        ...
        settings = {};
        controlModel = new NationalInstruments.HtmlVI.ProgressBarModel(id);
    });
    ...
    // -------------------------------------------------
    it('allows to call the progressBarModelMethods method', function () {
        ...
        controlModel.progressBarModelMethods();
    });
