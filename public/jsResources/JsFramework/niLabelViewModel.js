...
NationalInstruments.HtmlVI.LabelViewModel = function (element, model) {
    'use strict';
    // Properties
    ...
    // Methods
    if (typeof this.labelViewModelMethods !== 'function') {
        var proto = NationalInstruments.HtmlVI.LabelViewModel.prototype;
        proto.labelViewModelMethods = function () {
        };
...
NationalInstruments.HtmlVI.inheritFromParent(NationalInstruments.HtmlVI.LabelViewModel, NationalInstruments.HtmlVI.VisualViewModel);